...
import { imgColorSet } from "./svg-46yzk";
import svgPaths from "./svg-5uxkb1b1l7";
...
type CardOptionTextProps = {
  text: string;
};

function CardOptionText({ text }: CardOptionTextProps) {
  return (
    <div className="relative shrink-0">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[4px] items-center relative">
          <div className="relative shrink-0 size-[14px]" data-name="[Icon] Check">
            <div className="flex flex-col items-center justify-center size-full">
          ...
          <p className="font-['Pretendard:Medium',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#141414] text-[14px] tracking-[-0.3px] whitespace-nowrap">{text}</p>
        </div>
      </div>
    </div>
  );
...
function List({ text, text1 }: ListProps) {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[311px]">
      <div className="font-['Pretendard:Regular',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#141414] text-[14px] tracking-[-0.3px] w-full">
...
export default function A() {
  return (
    <div className="bg-white relative size-full" data-name="A_확장카드">
      ...
      <div className="absolute content-stretch flex flex-col gap-[8px] items-start left-[16px] top-[163px] w-[343px]">
        <div className="relative rounded-[8px] shrink-0 w-full" data-name="card">
          <div aria-hidden="true" className="absolute border-2 border-[#00a1ff] border-solid inset-0 pointer-events-none rounded-[8px]" />
          <div className="content-stretch flex flex-col gap-[4px] items-start p-[16px] relative w-full">
            <p className="font-['Pretendard:Bold',sans-serif] leading-[28px] min-w-full not-italic relative shrink-0 text-[#141414] text-[20px] tracking-[-0.3px] w-[min-content]">포장 이사</p>
            <div className="content-stretch flex flex-col gap-[13px] items-start relative shrink-0">
              <div className="content-stretch flex flex-col items-start relative shrink-0 w-[311px]" data-name="list">
                <p className="font-['Pretendard:Regular',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#141414] text-[14px] tracking-[-0.3px] w-full">짐 포장부터 운반, 도착 후 가구 배치와 짐 정리까지 모두 필요해요.</p>
              </div>
              ...
              <div className="content-stretch flex flex-col gap-[7px] items-start justify-center relative shrink-0 w-full" data-name="option">
                <CardOptionText text="출발지 짐 포장" />
                <CardOptionText text="이삿짐 운반" />
                <CardOptionText text="도착지 가구배치 및 짐 정리" />
              </div>
            </div>
          </div>
        </div>
        <div className="relative rounded-[8px] shrink-0 w-full" data-name="card/default">
          <div aria-hidden="true" className="absolute border border-[#e0e0e0] border-solid inset-0 pointer-events-none rounded-[8px]" />
          <div className="content-stretch flex flex-col gap-[4px] items-start p-[16px] relative w-full">
            <p className="font-['Pretendard:Bold',sans-serif] leading-[28px] min-w-full not-italic relative shrink-0 text-[#141414] text-[20px] tracking-[-0.3px] w-[min-content]">반포장 이사</p>
            <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0">
              <List text="짐 포장 및 운반만 필요해요." text1="도착 후 가구 배치와 짐 정리는 직접할게요." />
            </div>
          </div>
        </div>
        <div className="relative rounded-[8px] shrink-0 w-full" data-name="card/default">
          <div aria-hidden="true" className="absolute border border-[#e0e0e0] border-solid inset-0 pointer-events-none rounded-[8px]" />
          <div className="content-stretch flex flex-col gap-[4px] items-start p-[16px] relative w-full">
            <p className="font-['Pretendard:Bold',sans-serif] leading-[28px] min-w-full not-italic relative shrink-0 text-[#141414] text-[20px] tracking-[-0.3px] w-[min-content]">일반 이사</p>
            <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0">
              <List text="짐 운반만 필요해요." text1="도착 후 가구 배치와 짐 정리는 직접할게요." />
            </div>
          </div>
        </div>
      </div>
      <Title additionalClassNames="top-[95px]" text="원하는 이사 방식을 선택해 주세요" />
      ...
      <div className="-translate-x-1/2 absolute content-stretch flex gap-[4px] items-center left-1/2 top-[654px] w-[343px]" data-name="select">
        <div className="flex-[1_0_0] min-h-px min-w-px relative rounded-[4px]" data-name="🌀 Box Button">
          ...
          <Wrapper>
            <div className="flex flex-col font-['Pretendard:SemiBold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#00a1ff] text-[16px] text-center tracking-[-0.3px] whitespace-nowrap">
              <p className="leading-[20px]">네, 있어요</p>
            </div>
          </Wrapper>
        </div>
        <div className="flex-[1_0_0] min-h-px min-w-px relative rounded-[4px]" data-name="🌀 Box Button">
          ...
          <Wrapper>
            <div className="flex flex-col font-['Pretendard:SemiBold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#141414] text-[16px] text-center tracking-[-0.3px] whitespace-nowrap">
              <p className="leading-[20px]">없어요</p>
            </div>
          </Wrapper>
        </div>
      </div>
      <Title additionalClassNames="top-[586px]" text="TV·냉장고와 같은 큰 짐이 있나요?" />
    </div>
  );
}