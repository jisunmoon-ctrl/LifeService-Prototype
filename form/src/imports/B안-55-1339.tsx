...
import svgPaths from "./svg-mc6q8tc2xf";
...
type CommerceColorSetProps = {
  className?: string;
  value?: "🟠 foreground inverse weak" | "🟠 foreground review star" | "🟠 foreground review star toggle off" | "🟠 foreground today departure" | "🟠 foreground today deals";
};
...
function CommerceColorSet({ className, value = "🟠 foreground inverse weak" }: CommerceColorSetProps) {
  return (
    <div className={className || "relative size-[24px]"}>
      <div className={`absolute inset-0 ${value === "🟠 foreground today deals" ? "bg-[#ff4747]" : value === "🟠 foreground today departure" ? "bg-[#6131d2]" : value === "🟠 foreground review star toggle off" ? "bg-[#e8e8e8]" : value === "🟠 foreground review star" ? "bg-[#f7b401]" : "bg-[#b9b9b9]"}`} data-name="Color" />
    </div>
  );
}
...
type CommerceColorSet1Props = {
  className?: string;
  value?: "🟠 foreground inverse weak" | "🟠 foreground review star toggle off";
};

function CommerceColorSet1({ className, value = "🟠 foreground inverse weak" }: CommerceColorSet1Props) {
  return (
    <div className={className || "relative size-[24px]"}>
...
type OdsColorSet1Props = {
  className?: string;
  value?: "🌀 foreground" | "🌀 foreground weak" | "🌀 foreground brand" | "🌀 foreground inverse" | "🌀 foreground emphasis" | "🌀 foreground critical" | "🌀 foreground attention" | "🌀 foreground disabled";
};

function OdsColorSet1({ className, value = "🌀 foreground" }: OdsColorSet1Props) {
  const isForegroundDisabled = value === "🌀 foreground disabled";
  return (
    <div className={className || `relative size-[24px] ${isForegroundDisabled ? "bg-white" : ""}`}>
      <div className={`absolute inset-0 ${isForegroundDisabled ? "bg-[#c1c1c1]" : value === "🌀 foreground attention" ? "bg-[#b27800]" : value === "🌀 foreground critical" ? "bg-[#f05656]" : ["🌀 foreground brand", "🌀 foreground emphasis"].includes(value) ? "bg-[#00a1ff]" : value === "🌀 foreground inverse" ? "bg-white" : value === "🌀 foreground weak" ? "bg-[#8c8c8c]" : "bg-[#141414]"}`} data-name="Color" />
...
export default function B() {
  return (
    <div className="bg-white relative size-full" data-name="B안">
      ...
      <div className="absolute bg-white left-[48px] rounded-[4px] shadow-[0px_2px_5px_0px_rgba(63,71,77,0.15)] top-[222px] w-[311px]" data-name="🌀 Content Tooltip">
        <div className="overflow-clip rounded-[inherit] size-full">
          <div className="content-stretch flex gap-[12px] items-start px-[16px] py-[12px] relative w-full">
            <p className="flex-[1_0_0] font-['Pretendard:Regular',sans-serif] leading-[20px] min-h-px min-w-px not-italic relative text-[#2f3438] text-[14px] tracking-[-0.3px]">최근 3년간 오늘의집 실제 계약 견적을 바탕으로 한 평균가로 최종 견적은 다를 수 있어요.</p>
            <div className="content-stretch flex items-start pt-[4px] relative shrink-0" data-name="iconButtonSection">
              <div className="content-stretch flex items-start relative shrink-0" data-name="iconButton">
                <div className="relative shrink-0 size-[12px]" data-name="[Icon] X">
                  <Wrapper>
                    <div className="absolute inset-0 mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[3.55px_3.55px] mask-size-[16.9px_16.9px]">
                      <div className={`absolute inset-0 ${"🌀 ODS" === "🌐 GLOBAL" ? "bg-[#6131d2]" : "🌀 ODS" === "🟠 COMMERCE" ? "bg-[#b9b9b9]" : "bg-[#141414]"}`} data-name="Color" />
                    </div>
                  </Wrapper>
                </div>
