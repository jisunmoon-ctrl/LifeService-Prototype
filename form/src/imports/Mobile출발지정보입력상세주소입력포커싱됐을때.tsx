import svgPaths from "./svg-m9j9lpxngf";
import imgIOs3851 from "figma:asset/e61e2c00f823573caccf21cfd6014cced0243e11.png";
...
function Input() {
  return (
    <div className="absolute content-stretch flex inset-[40.39%_4.27%_53.45%_4.27%] items-center px-[16px] rounded-[4px]" data-name="Input">
...
function Button1() {
  return (
    <div className="bg-[#eaedef] content-stretch flex gap-[6px] h-[50px] items-center justify-center px-[16px] relative rounded-[4px] shrink-0 w-[107px]" data-name="Button">
      <div aria-hidden="true" className="absolute border border-[#dadde0] border-solid inset-0 pointer-events-none rounded-[4px]" />
...
export default function Mobile() {
  return (
    <div className="bg-white relative size-full" data-name="[MOBILE] 출발지 정보 입력(상세주소 입력 포커싱 됐을 때)">
      <Group1 />
      <Group />
      <ProgressbarMobile />
      ...
      <Input />
      <div className="absolute bg-[#00a1ff] inset-[41.87%_90.93%_54.93%_8.53%] rounded-[1px]" />
      <Input1 />
      <Button />
      <DropdownSelect />
      <DropdownSelect1 />
      ...
      <ButtonOnlyToolbar />
      <Indicator />
      <div className="absolute h-[380px] left-0 top-[432px] w-[375px]" data-name="iOS 이미지 (385) 1">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[213.68%] left-0 max-w-none top-[-113.68%] w-full" src={imgIOs3851} />
        </div>
      </div>
    </div>
  );
