import svgPaths from "./svg-r8hly01vow";
import { imgColorSet, imgColorSet1, imgColorSet2, imgColorSet3, imgColorSet4, imgColorSet5 } from "./svg-eawjs";
...
function Section() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-0 px-[16px] top-[563px] w-[375px]" data-name="Section">
