import svgPaths from "./svg-gfoj88mpg9";
import { imgColorSet, imgColorSet1, imgColorSet2, imgColorSet3, imgColorSet4, imgColorSet5 } from "./svg-3i7ei";
...
function Days() {
  return (
    <div className="cursor-pointer gap-y-[4px] grid grid-cols-[repeat(7,minmax(0,1fr))] grid-rows-[repeat(5,fit-content(100%))] overflow-clip relative shrink-0 w-full" data-name="Days">
      <button className="col-1 content-stretch flex h-[40px] items-center justify-center justify-self-stretch max-h-[40px] min-h-[40px] min-w-[40px] opacity-60 relative row-1 shrink-0" data-name="_Calendar / Calendar Day">
      ...
      <button className="col-2 content-stretch flex h-[40px] items-center justify-center justify-self-stretch max-h-[40px] min-h-[40px] min-w-[40px] opacity-60 relative row-1 shrink-0" data-name="_Calendar / Calendar Day">
        <div className="absolute inset-0" data-name="State">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
            <Circle1 />
          </div>
      ...
      <button className="col-3 content-stretch flex h-[40px] items-center justify-center justify-self-stretch max-h-[40px] min-h-[40px] min-w-[40px] opacity-60 relative row-1 shrink-0" data-name="_Calendar / Calendar Day">
        <div className="absolute inset-0" data-name="State">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
            <Circle2 />
          </div>
      ...
      <button className="col-4 content-stretch flex h-[40px] items-center justify-center justify-self-stretch max-h-[40px] min-h-[40px] min-w-[40px] relative row-1 shrink-0" data-name="_Calendar / Calendar Day">
        <div className="absolute inset-0" data-name="State">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
            <Circle3 />
          </div>
      ...
      <button className="col-5 content-stretch flex h-[40px] items-center justify-center justify-self-stretch max-h-[40px] min-h-[40px] min-w-[40px] relative row-1 shrink-0" data-name="_Calendar / Calendar Day">
        <div className="absolute inset-0" data-name="State">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
            <Circle4 />
          </div>
      ...
      <button className="col-6 content-stretch flex h-[40px] items-center justify-center justify-self-stretch max-h-[40px] min-h-[40px] min-w-[40px] relative row-1 shrink-0" data-name="_Calendar / Calendar Day">
        <div className="absolute inset-0" data-name="State">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
            <Circle5 />
          </div>
      ...
      <button className="col-7 content-stretch flex h-[40px] items-center justify-center justify-self-stretch max-h-[40px] min-h-[40px] min-w-[40px] relative row-1 shrink-0" data-name="_Calendar / Calendar Day">
        <div className="absolute inset-0" data-name="State">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
            <Circle6 />
          </div>
      ...
      <button className="col-1 content-stretch flex h-[40px] items-center justify-center justify-self-stretch max-h-[40px] min-h-[40px] min-w-[40px] relative row-2 shrink-0" data-name="_Calendar / Calendar Day">
        <div className="absolute inset-0" data-name="State">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
            <Circle7 />
          </div>
      ...
      <button className="col-2 content-stretch flex h-[40px] items-center justify-center justify-self-stretch max-h-[40px] min-h-[40px] min-w-[40px] relative row-2 shrink-0" data-name="_Calendar / Calendar Day">
        <div className="absolute inset-0" data-name="State">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
            <Circle8 />
          </div>
      ...
      <button className="col-3 content-stretch flex h-[40px] items-center justify-center justify-self-stretch max-h-[40px] min-h-[40px] min-w-[40px] relative row-2 shrink-0" data-name="_Calendar / Calendar Day">
        <div className="absolute inset-0" data-name="State">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
            <Circle9 />
          </div>
      ...
      <button className="col-4 content-stretch flex h-[40px] items-center justify-center justify-self-stretch max-h-[40px] min-h-[40px] min-w-[40px] relative row-2 shrink-0" data-name="_Calendar / Calendar Day">
        <div className="absolute inset-0" data-name="State">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
            <Circle10 />
          </div>
      ...
      <button className="col-5 content-stretch flex h-[40px] items-center justify-center justify-self-stretch max-h-[40px] min-h-[40px] min-w-[40px] relative row-2 shrink-0" data-name="_Calendar / Calendar Day">
        <div className="absolute inset-0" data-name="State">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
            <Circle11 />
          </div>
      ...
      <button className="col-6 content-stretch flex h-[40px] items-center justify-center justify-self-stretch max-h-[40px] min-h-[40px] min-w-[40px] relative row-2 shrink-0" data-name="_Calendar / Calendar Day">
        <div className="absolute inset-0" data-name="State">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
            <Circle12 />
          </div>
      ...
      <button className="col-7 content-stretch flex h-[40px] items-center justify-center justify-self-stretch max-h-[40px] min-h-[40px] min-w-[40px] relative row-2 shrink-0" data-name="_Calendar / Calendar Day">
        <div className="absolute inset-0" data-name="State">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
            <Circle13 />
          </div>
      ...
      <button className="col-1 content-stretch flex h-[40px] items-center justify-center justify-self-stretch max-h-[40px] min-h-[40px] min-w-[40px] relative row-3 shrink-0" data-name="_Calendar / Calendar Day">
        <div className="absolute inset-0" data-name="State">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
            <Circle14 />
          </div>
      ...
      <button className="col-2 content-stretch flex h-[40px] items-center justify-center justify-self-stretch max-h-[40px] min-h-[40px] min-w-[40px] relative row-3 shrink-0" data-name="_Calendar / Calendar Day">
        <div className="absolute inset-0" data-name="State">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
            <Circle15 />
          </div>
      ...
      <button className="col-3 content-stretch flex h-[40px] items-center justify-center justify-self-stretch max-h-[40px] min-h-[40px] min-w-[40px] relative row-3 shrink-0" data-name="_Calendar / Calendar Day">
        <div className="absolute inset-0" data-name="State">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
            <Circle16 />
          </div>
      ...
      <button className="col-4 content-stretch flex h-[40px] items-center justify-center justify-self-stretch max-h-[40px] min-h-[40px] min-w-[40px] relative row-3 shrink-0" data-name="_Calendar / Calendar Day">
        <div className="absolute inset-0" data-name="State">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
            <Circle17 />
          </div>
        ...
        <div className="-translate-x-1/2 -translate-y-1/2 absolute left-1/2 size-[5px] top-[calc(50%+13.5px)]" data-name="Dot">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5 5">
            <circle cx="2.5" cy="2.5" fill="var(--fill-0, #141414)" id="Dot" r="2.5" />
          </svg>
        </div>
        <p className="-translate-x-1/2 absolute font-['Pretendard:Regular',sans-serif] leading-[18px] left-1/2 not-italic text-[#141414] text-[14px] text-center top-[calc(50%-9px)] tracking-[-0.3px] whitespace-nowrap">15</p>
      </button>
      <button className="col-5 content-stretch flex h-[40px] items-center justify-center justify-self-stretch max-h-[40px] min-h-[40px] min-w-[40px] relative row-3 shrink-0" data-name="_Calendar / Calendar Day">
        <div className="absolute inset-0" data-name="State">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
            <Circle18 />
          </div>
      ...
      <button className="col-6 content-stretch flex h-[40px] items-center justify-center justify-self-stretch max-h-[40px] min-h-[40px] min-w-[40px] relative row-3 shrink-0" data-name="_Calendar / Calendar Day">
        <div className="absolute inset-0" data-name="State">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
            <Circle19 />
          </div>
      ...
      <button className="col-7 content-stretch flex h-[40px] items-center justify-center justify-self-stretch max-h-[40px] min-h-[40px] min-w-[40px] relative row-3 shrink-0" data-name="_Calendar / Calendar Day">
        <div className="absolute inset-0" data-name="State">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
            <Circle20 />
          </div>
      ...
      <button className="col-1 content-stretch flex h-[40px] items-center justify-center justify-self-stretch max-h-[40px] min-h-[40px] min-w-[40px] relative row-4 shrink-0" data-name="_Calendar / Calendar Day">
        <div className="absolute inset-0" data-name="State">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
            <Circle21 />
          </div>
      ...
      <button className="col-2 content-stretch flex h-[40px] items-center justify-center justify-self-stretch max-h-[40px] min-h-[40px] min-w-[40px] relative row-4 shrink-0" data-name="_Calendar / Calendar Day">
        <div className="absolute inset-0" data-name="State">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
            <Circle22 />
          </div>
      ...
      <button className="col-3 content-stretch flex h-[40px] items-center justify-center justify-self-stretch max-h-[40px] min-h-[40px] min-w-[40px] relative row-4 shrink-0" data-name="_Calendar / Calendar Day">
        <div className="absolute inset-0" data-name="State">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
            <Circle23 />
          </div>
      ...
      <button className="col-4 content-stretch flex h-[40px] items-center justify-center justify-self-stretch max-h-[40px] min-h-[40px] min-w-[40px] relative row-4 shrink-0" data-name="_Calendar / Calendar Day">
        <div className="absolute inset-0" data-name="State">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
            <Circle24 />
          </div>
      ...
      <button className="col-5 content-stretch flex h-[40px] items-center justify-center justify-self-stretch max-h-[40px] min-h-[40px] min-w-[40px] relative row-4 shrink-0" data-name="_Calendar / Calendar Day">
        <div className="absolute inset-0" data-name="State">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
            <Circle25 />
          </div>
      ...
      <button className="col-6 content-stretch flex h-[40px] items-center justify-center justify-self-stretch max-h-[40px] min-h-[40px] min-w-[40px] relative row-4 shrink-0" data-name="_Calendar / Calendar Day">
        <div className="absolute inset-0" data-name="State">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
            <Circle26 />
          </div>
      ...
      <button className="col-7 content-stretch flex h-[40px] items-center justify-center justify-self-stretch max-h-[40px] min-h-[40px] min-w-[40px] relative row-4 shrink-0" data-name="_Calendar / Calendar Day">
        <div className="absolute inset-0" data-name="State">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
            <Circle27 />
          </div>
      ...
      <button className="col-1 content-stretch flex h-[40px] items-center justify-center justify-self-stretch max-h-[40px] min-h-[40px] min-w-[40px] relative row-5 shrink-0" data-name="_Calendar / Calendar Day">
        <div className="absolute inset-0" data-name="State">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
            <Circle28 />
          </div>
      ...
      <button className="col-2 content-stretch flex h-[40px] items-center justify-center justify-self-stretch max-h-[40px] min-h-[40px] min-w-[40px] relative row-5 shrink-0" data-name="_Calendar / Calendar Day">
        <div className="absolute inset-0" data-name="State">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
            <Circle29 />
          </div>
      ...
      <button className="col-3 content-stretch flex h-[40px] items-center justify-center justify-self-stretch max-h-[40px] min-h-[40px] min-w-[40px] relative row-5 shrink-0" data-name="_Calendar / Calendar Day">
        <div className="absolute inset-0" data-name="State">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
            <Circle30 />
          </div>
      ...
      <button className="col-4 content-stretch flex h-[40px] items-center justify-center justify-self-stretch max-h-[40px] min-h-[40px] min-w-[40px] relative row-5 shrink-0" data-name="_Calendar / Calendar Day">
        <div className="absolute inset-0" data-name="State">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
            <Circle31 />
          </div>
      ...
      <button className="col-5 content-stretch flex h-[40px] items-center justify-center justify-self-stretch max-h-[40px] min-h-[40px] min-w-[40px] relative row-5 shrink-0" data-name="_Calendar / Calendar Day">
        <div className="absolute inset-0" data-name="State">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
            <Circle32 />
          </div>
      ...
      <button className="col-6 content-stretch flex h-[40px] items-center justify-center justify-self-stretch max-h-[40px] min-h-[40px] min-w-[40px] relative row-5 shrink-0" data-name="_Calendar / Calendar Day">
        <div className="absolute inset-0" data-name="State">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
            <Circle33 />
          </div>
      ...
      <button className="col-7 content-stretch flex h-[40px] items-center justify-center justify-self-stretch max-h-[40px] min-h-[40px] min-w-[40px] opacity-60 relative row-5 shrink-0" data-name="_Calendar / Calendar Day">
        <div className="absolute inset-0" data-name="State">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
            <Circle34 />
          </div>
...
function Container() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[20px] items-start left-0 top-[94px] w-[375px]" data-name="Container">
  ...
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="ButtonOnlyToolbar">
      <div className="content-stretch flex gap-[6px] items-start p-[6px] relative size-full">
        ...
        <div className="bg-[#ededed] flex-[1_0_0] h-[48px] max-h-[48px] min-h-[48px] min-w-px relative rounded-[8px]" data-name="🌀 Box Button">
          <div className="content-stretch flex items-center justify-center max-h-[inherit] min-h-[inherit] overflow-clip pl-px pr-[15px] py-px relative rounded-[inherit] size-full">
            <div className="flex flex-row items-center self-stretch">
              <div className="h-full mr-[-14px] relative shrink-0" data-name="Center">
                <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center px-[19px] relative size-full">
                  <div className="flex flex-col font-['Pretendard:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#c1c1c1] text-[16px] text-center tracking-[-0.3px] whitespace-nowrap">
