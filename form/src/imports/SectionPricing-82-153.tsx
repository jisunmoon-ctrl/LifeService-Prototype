      ...
      <div className="absolute bottom-full left-0 right-0 top-0" data-name="divider">
        <div className="absolute inset-[-1px_0_0_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 122 1">
            <line id="divider" stroke="var(--stroke-0, #E0E0E0)" x2="122" y1="0.5" y2="0.5" />
          </svg>
        </div>
      </div>
    </div>
    ...
    <div className="absolute bottom-full left-0 right-0 top-0">
      <div className="absolute inset-[-1px_0_0_0]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 99 1">
          <line id="divider" stroke="var(--stroke-0, #E0E0E0)" x2="99" y1="0.5" y2="0.5" />
        </svg>
      </div>
    </div>
  );
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative size-full" data-name="Section_pricing">
      ...
      <div className="content-stretch flex items-start pb-[16px] px-[16px] relative shrink-0 w-[375px]" data-name="contents">
        <div className="content-stretch flex flex-col items-start relative shrink-0 w-[99px]" data-name="row">
