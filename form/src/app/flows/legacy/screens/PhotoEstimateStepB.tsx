...
interface PhotoEstimateStepBProps {
...
export default function PhotoEstimateStepB({ onNavigate }: PhotoEstimateStepBProps) {
      ...
      <div className="absolute left-0 right-0 top-[94px] bottom-[96px] overflow-y-auto">
        <div className="content-stretch flex flex-col gap-4 items-start p-4">
          ...
          <div className="w-full">
            ...
            {/* 가이드 박스 */}
            <div className="bg-[#f5f5f5] rounded-lg p-4 w-full my-4">
              <button
            ...
            <h3 className="text-heading-18 font-semibold text-[var(--fg-neutral)] mb-3">
              1. 공간별 사진 촬영
            </h3>

            {/* 공간별 사진 목록 */}
            {rooms.map((room) => (
              <div key={room.id} className="w-full mb-4">
            ...
            <button
              ...
              className="w-full px-4 py-3 border border-[var(--border-neutral)] rounded flex items-center justify-center gap-2 hover:bg-[var(--bg-weak)] transition-default mb-6"
            >
          ...
          {/* 구분선 */}
          <div className="w-full h-[10px] bg-[#f7f9fa] -mx-4" style={{ width: 'calc(100% + 32px)' }}></div>

          {/* 섹션 2: 큰 짐 정보 */}
          <div className="w-full pt-2">
            <h3 className="text-heading-18 font-semibold text-[var(--fg-neutral)] mb-4">
              2. 큰 짐 정보 입력
            </h3>

            {/* 가전 */}
            <div className="w-full mb-6">
              <h4 className="text-body-16 font-semibold text-[var(--fg-neutral)] mb-3 px-2">
                가전
              </h4>
